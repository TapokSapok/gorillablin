	...
	return (
		<header className={styles.header}>
			<div className={styles.side}>
				<div className={styles.logo}>{/* <img src='./pancake-logo.png' alt='' width={38} /> */}</div>
			</div>
			<div className={styles.side}>
				{profile ? (
					<div className={styles.profile} ref={profileRef}>
						<div className={styles.name} onClick={() => setDropdownIsActive(!dropdownIsActive)}>
							{profile?.firstName} {profile?.lastName}
						</div>
						<ProfileMenu setCouponMenu={setCouponMenuIsActive} setIsActive={setDropdownIsActive} isActive={dropdownIsActive} />
